...
**Skills**: Python, Pandas, Scikit-learn, Streamlit, Data Cleaning, Data Wrangling, Categorical Encoding, Train-Test Splitting, Supervised Machine Learning, Regression, Classification, Model Evaluation, Hyperparameter Tuning, Data Visualization (Matplotlib)
...
**Portfolio Impact**: This project complements my data science portfolio by showing another side of machine learning: discovering patterns instead of predicting labels. It also demonstrates interactive Python development through a Streamlit app that responds to user-uploaded data, feature selections, model settings, and visualization choices. By deploying the app to Streamlit Community Cloud, this project shows that I can move beyond notebook analysis and package machine learning work into a shareable, user-facing tool.
